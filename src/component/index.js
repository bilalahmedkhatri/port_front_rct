...
export { default as Slider } from "./addons/Slider";
export { default as AboutList } from "./addons/AboutList";
...
export { default as ProjectsCard } from "./addons/ProjectsBox";
export { Context } from "./block/ProjectView";
// Block Component
...
export { default as FirstView } from "./block/FirstView";
