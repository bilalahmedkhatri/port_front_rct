...
const experience = [
    { designation: 'FullStack Python Developer', workDate: "April-2022 to Continue", company: 'UPWORK & FREELANCE', exp: "Built designed and maintained an ERP-apps for the INFINITY Pvt Ltd using CSS, XHTML, XML, Javascript, Python. Built custom websites using React, Material-UI, Bootstrap, axiosjs, asyncio, Django and Flask, including custom plug-ins and filters. Handling all verbal and written communications between hosting companies, clients, and vendors. Created reusable components with pep principles to code to allow for flexibility and expandability. " },
    { designation: 'Odoo Developer', workDate: "Nov-2021 to April-2022", company: 'Intelliversal Solutions, Karachi, PK', exp: "Customize and maintain existing modules of the Odoo ERP and develop new Modules.  Developing applications/ features that affect everyday life.Working with Business Consultant to design and develop ERP as per clients requirements.working on design tasks like HTML, CSS, SASS, Bootstrap, JavaScript, & XML.For Backend Functionallity PYTHON." },
        ...
        <Box sx={{ maxWidth: '100%' }}>
            <Stepper orientation="vertical" sx={{ '& .MuiStepConnector-line': { borderLeft: `2px solid ${green[500]}` } }} >
                {experience.map((step, index) => (
                    <Step key={index} active={true} sx={{ '& .MuiStepContent-root': { borderLeft: `2px solid ${green[500]}` } }}>
